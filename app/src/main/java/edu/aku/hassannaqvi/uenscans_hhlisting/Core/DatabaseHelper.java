package edu.aku.hassannaqvi.uenscans_hhlisting.Core;
...
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.BLRandomContract.singleRandomHH;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.EnumBlockContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.EnumBlockContract.EnumBlockTable;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.ListingContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.ListingContract.ListingEntry;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.SignupContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.SignupContract.SignUpTable;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.TeamsContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.TeamsContract.SingleTaluka;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.UsersContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.UsersContract.UsersTable;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.VersionAppContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.VersionAppContract.VersionAppTable;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.VerticesContract;
import edu.aku.hassannaqvi.uenscans_hhlisting.Contracts.VerticesContract.SingleVertices;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String FOLDER_NAME = "DMU-UEN-ScansPAKHHL";
